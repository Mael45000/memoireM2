...
# Nomme les colonnes du fichier de sortie.
...
for line in texte:
    ...
    # Recherche l'expression régulière dans le tweet converti en minuscule.
    if expr_reg :
        ...
        if token.pos_ == "VERB" and (token.text.endswith("é")):
            ...
            if token_penu.lemma_!="être" and token_penu.lemma_!="avoir":
                if token_antepenu.lemma_!="être" and token_antepenu.lemma_!="avoir":
                    ...
                    # Si les mots placés avant et en antépénultième position du verbe ne sont pas des auxiliaires, alors on extrait le verbe.
                    #print(token.text,line)
